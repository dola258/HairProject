...
<style>
	td { width: 40px; height: 40px; border-radius: 5px; text-align: center;}
</style>
<script type="text/javascript">
    ...
    $(function() {
    	 ...
    	 $('#calendar tbody td').on('click', function() {
			...
			location.href =  "http://localhost:9090/TeamProject1/hairline?cmd=RESERVE&idx="+idx+"&cname="+cname+"&ctel="+ctel+"&cbirth="+cbirth+"&rdate="+yy+MM+dd;
	...
	<div id="table">
		...
		<div class="row">
			...
			<span class="cell" id="td2-2">
				<h1>날짜선택</h1>
				<table id="calendar"  align="center" width="600px" height="400px;" >
    				<thead><!-- label은 마우스로 클릭을 편하게 해줌 -->
        				<td><label onclick="prevCalendar()">◁prev</label></td>
        				<td align="center" id="tbCalendarYM" colspan="5">yyyy년 m월</td>
        				<td><label onclick="nextCalendar()">next▷</label></td>
    				</thead>
    				<tbody>
	    				<tr>
